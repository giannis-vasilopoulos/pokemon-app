...
The following would normally be implemented; deferred for time. Rationale where documented: [Team slots](docs/DECISIONS.md#team-slots-zustand--url) (detail-page Add to Team), [AI suggestion](docs/DECISIONS.md#ai-team-suggestion-deferred).
